...
- 애플리케이션 코드
  - `/Users/yangyewon/workspace/shopping-mall-k8s-lab/E-commerce/app/services/order-service`
  - Outbox 관련 엔티티, 레포지토리, 서비스 로직은 여기서 관리

- 소비자 코드
  - 기존 서비스를 재사용하면 해당 서비스 내부에 구현
  - 별도 실습용 consumer는 `/Users/yangyewon/workspace/shopping-mall-k8s-lab/E-commerce/app/services/event-consumer` 에 둔다
...
- 문서
  - `/Users/yangyewon/workspace/shopping-mall-k8s-lab/E-commerce/app/docs/lab2`
